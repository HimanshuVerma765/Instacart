...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-[#1b3022] via-[#2d4a35]/65  to-transparent" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold text-[#fdba74] bg-[#fdba74]/10 rounded-full mb-5">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">
            ...
            <span className="text-[#fdba74]"> Earth's finest</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to="/products"
              className="px-7 py-3 bg-[#fb923c] text-white font-semibold rounded-full hover:bg-[#f97316] transition-all flex-center gap-2 active:scale-[0.98]"
            >
