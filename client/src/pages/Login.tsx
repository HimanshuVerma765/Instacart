        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="text-sm flex flex-col gap-1">
              Email address
              <div className="relative">
                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 text-app-text-light size-4" />
                <input
                  type="email"
                  value={email}
            ...
            <label className="text-sm flex flex-col gap-1">
              Password
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-app-text-light size-4" />
                <input
                  type="password"
                  value={password}
