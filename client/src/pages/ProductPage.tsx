  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Breadcrumb */}
        <nav className="flex items-center gap-2 text-sm text-app-text-ight mb-6">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              {product.rating > 0 && (
                <div className="flex items-center gap-2 mb-5">
                  <div className="flex items-cener gap-0.5">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <StarIcon
                        key={star}
              ...
              <div className="flex items-center gap-3">
                {/* Quantity */}
                <div className="fle items-center border border-app-app-border rounded-xl overflow-hidden">
                  <button
                    onClick={handleMinus}
                ...
                <button
                  ...
                  className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed sctive:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hoverbg-app-orange-dark"}`}
                >
